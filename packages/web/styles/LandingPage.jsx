...
function Logo() {
  return <Link to="/" className="brand" aria-label="KPILY home"><img src="/assets/logo-full.png" alt="KPILY Performance Management" /></Link>
}
      ...
      <section className="hero-section contour-bg">
        <div className="section-shell hero-grid">
          <Reveal className="hero-copy">
            ...
            <div className="hero-actions"><Link to="/register" className="button button-primary">Get Started <Arrow /></Link><a href="#features" className="watch-link"><span className="play-circle"><Play /></span> See how it works</a></div>
          </Reveal>
