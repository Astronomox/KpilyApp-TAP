...
import { startPasswordReset } from '@/lib/kpily'
...
export default function ForgotPassword() {
  ...
  const mobile = (
    <MobileAuth title={<>Forgot<br />password?</>} art="/figma/forgot/team.png"
      ...
      <form className="kp-m-form" onSubmit={submit}>
        ...
        {sent && <p role="status" className="kp-m-status">Check {email} for a link to reset your password.</p>}
  ...
  return (
    <>
    {busy && <PageLoader label="Sending reset link" />}
    <Artboard mobile={mobile}>
      ...
      <form onSubmit={submit}>
        ...
        {sent && <p role="status" style={at(91, 625, 300, undefined, pop(500, 12, 18, '#166448'))}>Check {email} for a link to reset your password.</p>}
        {error && <p role="alert" style={at(91, 625, 300, undefined, pop(500, 12, 18, '#b65a50'))}>{error}</p>}
      </form>
