    ...
    <div className="kp kp-site kp-home">
      ...
      <main>
        <section className="kp-home__hero kp-home__container">
          <div className="kp-home__hero-copy">
          ...
          <img className="kp-home__hero-img" src="/site/hero-img.png" alt="Employee receiving real-time feedback and points in KPILY" />
        </section>

        <section className="kp-home__clients kp-home__container">
          <h2>Over 32k+ Technology businesses growing with KPILY</h2>
          <div className="kp-home__logos">
            {CLIENTS.map((c) => <img key={c} src={`/site/${c}.png`} alt={c} />)}
          </div>
        </section>

        <section id="features" className="kp-home__container kp-home__feature kp-home__feature--reverse">
          <div className="kp-home__feature-copy">
          ...
          <img className="kp-home__feature-img" src="/site/real-time-feedback.png" alt="Real-time feedback dashboard with points received" />
        </section>

        <section className="kp-home__container kp-home__rel">
          <img className="kp-home__birds" src="/site/birds.png" alt="" aria-hidden="true" />
          <div className="kp-home__card kp-home__rewards">
            <div>
              <Eyebrow>Our Features</Eyebrow>
        ...
        <section className="kp-home__container kp-home__feature">
          ...
          <img className="kp-home__feature-img" src="/site/customizable-kpis.png" alt="Customizable KPI progress card" />
        </section>

        <section className="kp-home__container kp-home__testimonials">
          <Eyebrow>Testimonials</Eyebrow>
          <h2>Check what our clients are saying</h2>
          <div className="kp-home__arrows">
        ...
        <section className="kp-home__container">
          <div className="kp-home__journey">
        ...
        <section className="kp-home__container kp-home__feature kp-home__rel">
          ...
          <img className="kp-home__feature-img" src="/site/leaderboard-tracking.png" alt="Team leaderboard" />
        </section>

        <section className="kp-home__container kp-home__rel">
          <img className="kp-home__feathers kp-home__feathers--tl" src="/site/feathers.png" alt="" aria-hidden="true" />
          <div className="kp-home__card kp-home__why">
            ...
            <div className="kp-home__reasons">
              {REASONS.map((r) => (
                <article key={r.title}>
                  <span className="kp-home__dot" style={{ background: r.color }} />
        ...
        <section className="kp-home__container kp-home__rel">
          <img className="kp-home__feathers kp-home__feathers--tr" src="/site/feathers.png" alt="" aria-hidden="true" />
          <img className="kp-home__feathers kp-home__feathers--bl" src="/site/feathers.png" alt="" aria-hidden="true" />
          <div className="kp-home__card kp-home__plans">
            <Eyebrow>Choose A Plan</Eyebrow>
            <BillingToggle value={billing} onChange={setBilling} />
            <div className="kp-home__plan-grid">
              {PLANS.map((p) => (
                <article key={p.id} className={`kp-home__plan kp-home__plan--${p.tone}`}>
                  <h3>{p.name}</h3>
