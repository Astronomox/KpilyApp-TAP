  ...
  const posts = [
    {
      ...
      author: 'John Doe',
      date: 'Sep 20, 2024',
      image: '/public/assets/landing/real-time-feedback.png'
    },
    {
      id: 2,
      ...
      author: 'Jane Smith',
      date: 'Sep 18, 2024',
      image: '/public/assets/landing/customizable-kpis.png'
    },
    {
      id: 3,
      ...
      author: 'Mike Johnson',
      date: 'Sep 15, 2024',
      image: '/public/assets/landing/leaderboard-tracking.png'
    },
    {
      id: 4,
      ...
      date: 'Sep 12, 2024',
      image: '/public/assets/landing-testimonial.jpg'
    }
  ]
        ...
        {posts.map((post) => (
          <article key={post.id} className="blog-card">
            ...
            <div className="blog-content">
              ...
              <Link to="/blog-post" className="read-more">Read More →</Link>
            </div>
          </article>
        ))}
      </section>
